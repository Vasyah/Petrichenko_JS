...
var personalMovieDB = {
  ...
  start: function start() {
    var movNum = prompt('Сколько фильмов вы уже посмотрели?', '');
  ...
  // Добавляет moviesNum свойств к свойству ['movies'] к текущему
  addMoviestoDB: function addMoviestoDB(moviesNum) {
    for (var i = 0; i < moviesNum; i++) {
      var movieName = prompt('Один из последних просмотренных фильмов?'); // проверка на ошибку ввода

      while (movieName === null || movieName === '') {
        movieName = prompt('Один из последних просмотренных фильмов?');
      }

      var movieScore = prompt('На сколько оцените его?'); // проверка на ошибку ввода
  ...
  writeYourGenres: function writeYourGenres() {
    for (var genreNumber = 1; genreNumber <= 3; genreNumber++) {
      var genre = prompt("\u0412\u0430\u0448 \u043B\u044E\u0431\u0438\u043C\u044B\u0439 \u0436\u0430\u043D\u0440 \u043F\u043E\u0434 \u043D\u043E\u043C\u0435\u0440\u043E\u043C ".concat(genreNumber));

      while (!isNaN(genre) || genre === null || genre === '') {
        genre = prompt("\u0412\u0430\u0448 \u043B\u044E\u0431\u0438\u043C\u044B\u0439 \u0436\u0430\u043D\u0440 \u043F\u043E\u0434 \u043D\u043E\u043C\u0435\u0440\u043E\u043C ".concat(genreNumber));
      }
    ...
    this['genres'].forEach(function (item, index) {
      console.log("".concat(index + 1, " - \u044D\u0442\u043E ").concat(item));
    });
  },
  ...
  toggleVisibleDB: function toggleVisibleDB() {
    if (this.privat) {
      this.privat = false;
    } else {
      this.privat = true;
